...
<html lang="tr">
  ...
  <body>
      <div class="sondepremler">
        <div class="container">
        <h1>TÜRKİYE VE YAKIN ÇEVRESİNDEKİ SON DEPREMLER (DETAYLI)</h1>
        <a href="javascript:history.back(-1)" title="Geri Dön"><i class="fas fa-chevron-circle-left"></i> Geri Dön</a> -
        <a href="#" title="Detaylı Gösterim Sayfası">DETAYLI GÖSTERİM</a> -
        <a href="/sondepremler/bilgilendirme.html" title="Bilgilendirme Sayfası">BİLGİLENDİRME</a> -
        <a href="/sondepremler/depremaninda.html" title="Deprem Anında Sayfası">DEPREM ANINDA YAPILMASI GEREKENLER</a>
        </div>
      <div class="deprem">
      <div class="select">
    ...
    if (!@$array['depremler'][0]) {
      ...
      for ($x = 0; $x <= 500; $x++) {
        ...
        ?>
            ...
            <tr>
              <td><?php @print($array['depremler'][$x]['Yer']); ?></td>
              <td><?php @print($array['depremler'][$x]['Tarih']); ?></td>
              <td><?php @print($array['depremler'][$x]['Saat']); ?></td>
              <td><?php @print($array['depremler'][$x]['Enlem(N)']); ?></td>
              <td><?php @print($array['depremler'][$x]['Boylam(E)']); ?></td>
              <td><?php @print($array['depremler'][$x]['Derinlik(km)']); ?></td>
              <td><b><?php @print($array['depremler'][$x]['Buyukluk']['MD']); ?></b></td>
              <td><b><?php @print($array['depremler'][$x]['Buyukluk']['ML']); ?></b></td>
              <td><b><?php @print($array['depremler'][$x]['Buyukluk']['Mw']); ?></b></td>
              <td class="title"><?php @print($array['depremler'][$x]['Nitelik']); ?></td>
            </tr>
        <?php
      }
    }
